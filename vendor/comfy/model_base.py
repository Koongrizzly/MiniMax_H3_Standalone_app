...
class MiniMaxH3(BaseModel):
    ...
    def extra_conds(self, **kwargs):
        ...
        if audio_keyframes is not None:
            ...
            payload["cond_audio_latents"] = [kf["latent"] for kf in audio_keyframes]
        ...
        if cross_attn is not None and latent_shapes is not None and len(latent_shapes) > 1:
            ...
            payload["layout"] = comfy.ldm.minimax.model.PackedLayout(
                ...
                latent_shapes[1][-1], keyframes=payload.get("keyframes"), audio_keyframes=payload.get("audio_keyframes"),
